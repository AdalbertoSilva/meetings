...
<div class="container">
    ...
    <div class="col-md-12">
        <div class="row">
            <?= anchor('reservations/create', 'Novo Cadastro', array('class' => 'btn btn-success')); ?>
        </div>
        <div class="alert">
        ...
        <div class="row">
            <?php if ($reservations->num_rows() > 0): ?>
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php foreach($reservations->result() as $reservation): ?>
                        <tr>
                            <td><?= $reservation->id ?></td>
                            <td><?= $reservation->userName ?></td>
                            <td><?= $reservation->roomName ?></td>
                            <td><?= $reservation->reservationDate ?></td>
                            <td><a href="#" class='confirma_exclusao' data-id="<?= $reservation->id ?>" data-name="<?= $reservation->id ?>" />Excluir</a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
...
<script>
    ...
    $(function(){
        ...
        $('#btn_excluir').click(function(){
            ...
            document.location.href = base_url + "/reservations/delete/"+id;
        });
    });
</script>
