...
<div class="container">
    ...
    <div class="col-md-12">
        <div class="row">
            <?= anchor('users/create', 'Novo Cadastro', array('class' => 'btn btn-success')); ?>
        </div>
        <div class="alert">
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach($users->result() as $user): ?>
                        <tr>
                            ...
                            <td><?= $user->name ?></td>
                            <td><?= $user->email ?></td>
                            <td><?= anchor("users/edit/$user->id", "Editar") ?>
                                | <a href="#" class='confirma_exclusao' data-id="<?= $user->id ?>" data-name="<?= $user->name ?>" />Excluir</a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
...
<script>
    ...
    $(function(){
        ...
        $('#btn_excluir').click(function(){
            ...
            document.location.href = base_url + "/users/delete/"+id;
        });
    });
</script>
